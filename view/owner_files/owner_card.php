...
<div class="row text-dark bg-white ml-0 mr-0 border-top-0 p-3 mb-2">
		<div class="col">
			...
			<input type="text" placeholder="<?php echo $pom['responsible_person']?>" class="form-control form-control-sm" readonly>
...
<div class="row bg-white mr-0 ml-0">
	<div class="col mt-2">
		<div class="row  ml-0 mr-0">				
			<div class="col mt-2">
				<div class="form-group">
					<a class="btn btn-outline-secondary form-control mb-2" href="delete&id=<?php echo $pom['id_owner'];?>&class=owners">Delete</a>
					<a class="btn btn-outline-secondary form-control mb-2" href="product&id_owner=<?php echo $pom['id_owner'];?>">Add product</a>
					<a class="btn btn-outline-secondary form-control mb-2 text-center" href="card&id=<?php echo $pom['id_owner'];?>&class=owners_edit">Edit</a>
				</div>
			</div>
		</div>
	</div>
		...
		<input type="text" placeholder="<?php echo $pom['phone']?>" class="form-control form-control-sm"readonly>
	...
	<div class="col text-dark mt-2">
		<span class="small">Products id:</span>
			...
			<a href="card&id=<?php echo $nek['id_products']?>&class=products" class="badge-pill badge-light"><?php echo $nek['id_products'];?></a>
			<?php }?>
		</div>
...
<div class="row bg-white text-dark mt-2 ml-1 mr-1 border">
	...
	<div class="col mt-2 mb-3">
		...
		<input type="text" placeholder="<?php echo $pom['phone_4']?>" class="form-control form-control-sm"readonly>
...
<div class="row bg-white text-dark mt-2 ml-1 mr-1 border ">
	...
	<div class="col mt-2 mb-3">
		...
		<input type="text" placeholder="<?php echo $pom['activity_code']?>" class="form-control form-control-sm"readonly>
	</div>
