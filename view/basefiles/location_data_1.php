...
<form action="routes.php" method="post">
	...
	<div class="row justify-content-center text-white mt-1">
		...
		<div class="col-6 col-sm-5 text-left text-info mb-2 pt-1 border-bottom">
			<span><?php echo $gr['name_location_1'];?></span>
		</div>
		<div class="col-6 col-sm-3 text-center mb-2 border-bottom">
			<a href="routes.php?page=deletelocation1&id_location_1=<?php echo $gr['id_location_1'];?>" class="btn btn-light btn-sm btn-block" role="button" aria-pressed="true"><strong class="text-danger">X</strong></a>
		</div>
		<?php  } ?>
	</div>
	...
	<div class="row justify-content-center text-dark mt-2">	
		...
		<div class="col-6 col-sm-3 text-center">
			<input type="text" name="new_location_1" maxlength="20" class="form-control pt-1 pb-1">
		</div>
	</div>
	...
	<div class="row justify-content-center text-white mt-2">	
		...
		<div class="col-6 col-sm-3 text-center">
			<button class="btn btn-sm btn-secondary btn-block" type="submit" name="page" value="newlocation1">Add</button>
		</div>
	</div>
</form>