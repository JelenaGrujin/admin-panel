			...
			<div class="row bg-white border ml-0 mr-0">				
				<div class="col mt-3 mb-3">
					<div class="form-group">
						<a class="btn btn-outline-secondary form-control form-control mb-2" href="delete&id=<?php echo $pom['id_products'];?>&class=products">Delete</a>
						<a class="btn btn-outline-secondary form-control form-control mb-2 text-center" href="card&id=<?php echo $pom['id_products'];?>&class=products_edit">Edit</a>
						<a class="btn btn-outline-secondary form-control form-control mb-2 text-center" href="card&id=<?php echo $pom['id_owner']?>&class=owners_card">Owner view</a>
					</div>
				</div>
				<div class="col mt-2 mb-3">
					...
					<input type="text" placeholder="<?php echo $pom['place']?>" class="form-control form-control-sm" readonly>
					<span class="small text-dark">Floor:</span>
					<div class="row">
						<div class="col">
						<input type="text" placeholder="<?php echo $pom['floors']?>" class="form-control form-control-sm" readonly>
					</div>
					<div class="pt-1 text-dark"> of </div>
						<div class="col">
							<input type="text" placeholder="<?php echo $pom['of_floors']?>" class="form-control form-control-sm" readonly>
						</div>
					</div>
				...
				<div class="col mt-2 mb-3">
					...
					<input type="text" placeholder="<?php echo $pom['address_location']?>" class="form-control form-control-sm" readonly>
					...
					<div class="row">
						...
						<div class="col">
						<span class="small text-dark">street no</span>
						<input type="text" placeholder="<?php echo $pom['address_num']?>" class="form-control form-control-sm" readonly>
						</div>
				...
				<div class="col mt-2 mb-3">
					...
					<input type="text" placeholder="<?php echo $pom['construction_year']?>" class="form-control form-control-sm" readonly>
				...
				<div class="col mt-2 mb-3">
                    ...
                    <span class="small text-dark">Ceiling height:</span>
                    <input type="text" placeholder="<?php echo $pom['ceiling_height']?>" class="form-control form-control-sm" readonly>
				...
				<div class="col mt-2 mb-3">
					...
					<input type="text" placeholder="<?php echo $pom['elect']?>" class="form-control form-control-sm" readonly>
