<h4 class="display-5 text-secondary mt-4 text-center">Location 3</h4>
	...
	<div class="row justify-content-center text-white mt-1">
		...
		<div class="col-6 col-sm-5 text-left text-info mb-2 pt-1 border-bottom">
			<span><?php echo $li['name_location_3'];?></span>
		</div>
		<div class="col-6 col-sm-3 text-center mb-2 border-bottom">
			<a href="delete&id=<?php echo $li['id_location_3'];?>&class=locationThree" class="btn btn-light btn-sm btn-block" role="button" aria-pressed="true"><strong class="text-danger">X</strong></a>
		</div>
		<?php  } ?>
	</div>
<form action="new_three" method="post">
