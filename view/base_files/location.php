			...
			<div class="btn-group-vertical btn-block">
				<ul class="navbar-nav text-info w-100">
					<li class="nav-item mb-2">
						<a href="location" class="btn btn-outline-secondary btn-block <?php echo $page_loc_1;?> btn-block">Location data 1: </a>
					</li>
					<li class="nav-item text-info mb-2">
						<a href="location2" class="btn btn-outline-secondary btn-block <?php echo $page_loc_2;?> btn-block">Location data 2: </a>
					</li>
					<li class="nav-item text-info mb-2">
						<a href="location3" class="btn btn-outline-secondary btn-block <?php echo $page_loc_3;?> btn-block">Location data 3: </a>
					</li>
				</ul>
			</div>			
		</div>
