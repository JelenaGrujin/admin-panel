...
<form class="form" action="routes.php" method="POST">
	...
	<div class="row text-dark mr-0 ml-0">
		...
		<div class="col mt-2">			
			...
			<input type="text" placeholder="<?php echo $pom['datum_prijema']?>" class="form-control form-control-sm" readonly>	
			
			<span class="small ">Updated:</span>
			<input type="text" placeholder="<?php echo $pom['datum_izmene']?>" class="form-control form-control-sm" readonly>		
		</div>
	...
	<div class="row mt-2 ml-1 mr-1 border ">
		...
		<div class="col-3 mt-2 mb-3">
			...
			<input type="text" name="company_adres" maxlength="130" value="<?php if(isset($company_adres)){echo $company_adres;}elseif (isset($pom['company_adres'])) echo $pom['company_adres']?>" class="form-control form-control-sm">	
		</div>
	</div>
	...
	<div class="row text-dark mt-2 ml-1 mr-1 border">
		...
		<div class="col mt-2 mb-3">
			...
			<input type="text" name="b_day" maxlength="11" value="<?php if(isset($b_day)){echo $b_day;}elseif (isset($pom['b_day'])) echo $pom['b_day']?>" class="form-control form-control-sm">	
		</div>
	...
	<div class="row justify-content-around m-0">
		<div class="col-4">
			<button class="btn btn-sm btn-primary btn-block mt-2 pt-2 pb-2" type="submit" name="page" value="confirm_edit_owner"><strong>Confirm</strong></button>
		</div>
	</div>
	<?php }?>
</form>
