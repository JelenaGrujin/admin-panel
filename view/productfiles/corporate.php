...
?>
	...
	<div class="row mt-4 pb-3 bg-light text-danger border border-primary">
			...
			<input type="hidden" name="owner_type" value="corporate">
...
<div class="row mt-2 bg-white text-danger">
	...
	<div class="col-10">
	<div class="row border-success border vlasnik-bg">
		...
		<div class="mt-2 mb-3">
			<span class="small text-dark">Company number:</span><span class="msg"><?php if(array_key_exists('company_num', $errors)) echo $errors['company_num']?></span>
		...
		<div class="col-4 mt-2 mb-3">
			...
			<input type="text" name="company_adres" maxlength="30" value="<?php if (isset($company_adres)) echo $company_adres;?>" class="form-control form-control-sm">	
		</div>
	</div>
