			...
			<div class="btn-group-vertical">
				...
				<ul class="navbar-nav text-white">
					<li class="nav-item mb-2">
						<a href="corporate" class="btn btn-outline-primary <?php echo $page_prav;?>">corporate</a>
					</li>
					<li class="nav-item">
						<a href="personal" class="btn btn-outline-primary <?php echo $page_fizi;?>">personal</a>
					</li>
				</ul>
			</div>			
		</div>
