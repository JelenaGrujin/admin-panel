...
class newProductController extends Controller{
	...
	public function pause(){
		...
		$productinfo=array($id_euro, $location_data_1, $location_data_2, $location_data_3, $addres_location, $adres_num, $number, $object, $flors, $of_flors, $price, $min_price, $deposit, $commission, $payment, $square, $surface_area, $equipment, $celing_height, $structure, $heating, $carpentry, $kitchen, $num_rooms, $num_bath, $num_wc, $num_terrace, $level, $salon_m, $security, $num_elevator, $construc_year, $num_air_con, $num_garages, $note, $description, $active, $active_data, $info, $electricity, $network, $maintenance, $accessories, $garage, $provider, $type_terrace, $type_bath, $product_type);
		...
		if ($productinfo){
			...
			$typelist=$this->daotype->selectFromType();
			$somedatalist=$this->daoequipment->selectFromEquipment();
			$listlocation1=$this->daolone->selectFromLocation1();
			$listlocation2=$this->daoltwo->selectFromLocation2();
			$listlocation3=$this->daolthree->selectFromLocation3();
	...
	if (count($errors)==0){
		...
		$productinfo=array($id_euro, $date_insert, $location_data_1, $location_data_2, $location_data_3, $addres_location, $adres_num, $number, $object, $flors, $of_flors, $price, $min_price, $deposit, $commission, $payment, $square, $surface_area, $equipment, $celing_height, $structure, $heating, $carpentry, $kitchen, $num_rooms, $num_bath, $num_wc, $num_terrace, $level, $salon_m, $security, $num_elevator, $construc_year, $num_air_con, $num_garages, $note, $description, $active, $active_data, $info, $electricity, $network, $maintenance, $accessories, $garage, $provider, $type_terrace, $type_bath, $product_type, $business_status);
			if ($productinfo){
				session_start();
				$_SESSION['product']=array();
				$_SESSION['product'][]=$productinfo;
